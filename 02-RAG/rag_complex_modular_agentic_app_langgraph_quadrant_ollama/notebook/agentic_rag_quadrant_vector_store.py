...
# run this only in colab, otherwise create a venv and install requirements.txt available in the project folder
#get_ipython().system('pip install --quiet --upgrade langgraph')
#get_ipython().system('pip install -qU langchain-ollama')
#get_ipython().system('pip install -qU langchain langchain-community langchain-qdrant langchain-huggingface qdrant-client fastembed flashrank langchain-core')
